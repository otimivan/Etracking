...
$(document).ready(function () {
    ...
    function GetAllGroups() {
        $('#page-wrapper').mask();
        var formURL = 'http://etrackingapp.000webhostapp.com/ourApp/service/admin/getgroups.php';
        $.ajax(
        {
            url: formURL,
            type: "POST",
    ...
    if (GetQueryStringParams('gId') != undefined) {
        $('#page-wrapper').mask();
        var formURL = 'http://etrackingapp.000webhostapp.com/ourApp/service/admin/getgroup.php?gId=' + GetQueryStringParams('gId');
        $.ajax(
        {
            url: formURL,
            type: "POST",
    ...
    $("#frmGroups").submit(function (e) {
        ...
        var formURL;
        if (GetQueryStringParams('gId') == undefined) {
            formURL = 'http://etrackingapp.000webhostapp.com/ourApp/service/admin/addgroup.php';
        }
        else {
            formURL = 'http://etrackingapp.000webhostapp.com/ourApp/service/admin/updategroup.php';
        }
    ...
    $('#btnDelete').click(function () {
        $('#myModalt').mask();
        var formURL = 'http://etrackingapp.000webhostapp.com/ourApp/service/admin/deletegroup.php?gId=' + $('#hidId').val();
        $.ajax(
        {
            url: formURL,
            type: "POST",
