...
$(document).ready(function () {
    ...
    $("#frmSetting").submit(function (e) {
        ...
        var formURL;
        if (readCookie("rname") == "admin") {
            formURL = 'http://etrackingapp.000webhostapp.com/ourApp/service/admin/updatepassword.php';;
        }
        else {
            formURL = 'http://etrackingapp.000webhostapp.com/ourApp/service/admin/updateadminpassword.php';;
        }
