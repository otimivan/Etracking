...
$(document).ready(function () {
    ...
    function BindDistricts() {
        $('#page-wrapper').mask();
        var formURL = 'http://etrackingapp.000webhostapp.com/ourApp/service/admin/getdistricts.php';
        $.ajax(
        {
            url: formURL,
            type: "POST",
    ...
    $('#ddlDistricts').change(function () {
        if ($('#ddlDistricts').val() != "") {
            $('#page-wrapper').mask();
            var formURL = 'http://etrackingapp.000webhostapp.com/ourApp/service/admin/getgroupsbydistrict.php?disId=' + $('#ddlDistricts').val();
            $.ajax(
            {
                url: formURL,
                type: "POST",
    ...
    function PopulateFields(state) {
        $('#page-wrapper').mask();
        var formURL = 'http://etrackingapp.000webhostapp.com/ourApp/service/admin/getemployee.php?empId=' + GetQueryStringParams('empId');
        $.ajax(
        {
            url: formURL,
            type: "POST",
    ...
    $("#frmAddCustomer").submit(function (e) {
        ...
        if ($('.image-preview-filename').val() != "") {
            var formURL = 'http://etrackingapp.000webhostapp.com/ourApp/service/admin/uploademployeeimg.php';
        ...
        if (GetQueryStringParams('empId') == undefined) {
            formURL = 'http://etrackingapp.000webhostapp.com/ourApp/service/admin/addemployee.php';
        }
        else {
            formURL = 'http://etrackingapp.000webhostapp.com/ourApp/service/admin/updateemployee.php';
        }
    ...
    if (pageName === "Employees") {
        ...
        var formURL;
        if (readCookie("rname") == "admin") {
            formURL = 'http://etrackingapp.000webhostapp.com/ourApp/service/admin/allemployeesbygroup.php?gId=' + readCookie("groupId");
        }
        else {
            formURL = 'http://etrackingapp.000webhostapp.com/ourApp/service/admin/allemployees.php';
        }
        $.ajax(
        {
            url: formURL,
                ...
                if (record.length > 0) {
                    ...
                    for (var i = 0; i < record.length; i++) {
                        tbody += '<tr class="odd gradeX">'
                                      ...
                                      + '<td><img src="http://etrackingapp.000webhostapp.com/ourApp/images/employee/' + record[i].photo + '" class="img-circle" width="40" /></td>'
    ...
    $('#btnDelete').click(function () {
        $('#myModalt').mask();
        var formURL = 'http://etrackingapp.000webhostapp.com/ourApp/service/admin/deleteemployee.php?empId=' + $('#hidEmpId').val();
        $.ajax(
        {
            url: formURL,
            type: "POST",
